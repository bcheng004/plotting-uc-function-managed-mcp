...
try:
    ...
    agent = AgentEndpointClient(
        agent_endpoint_name=AGENT_ENDPOINT_NAME, workspace_client=workspace_client
    )
...
st.set_page_config(
    page_title="Agent Chat", layout="wide", initial_sidebar_state="collapsed"
)
                    ...
                    if plotly_json:
                        ...
                        with st.expander(
                            ...
                            fig.update_layout(
                                ...
                                paper_bgcolor="white",
                                font=dict(
                                    color="#000000", size=14, family="Arial, sans-serif"
                                ),
                                title_font=dict(
                                    color="#000000",
                                    size=18,
                                ...
                                xaxis=dict(
                                    ...
                                    color="#000000",
                                    title_font=dict(
                                        size=14, color="#000000", weight="bold"
                                    ),
        ...
        with st.chat_message("assistant"):
            ...
            if agent_response.get("error"):
                ...
                response_text = agent_response.get(
                    "response", "Agent processed your request"
                )
